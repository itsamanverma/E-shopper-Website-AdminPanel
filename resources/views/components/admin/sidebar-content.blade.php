...
<div x-show="sidebarOpen" 
     ...
     class="relative flex-1 flex flex-col max-w-xs w-full bg-admin-dark lg:hidden">
...
<script type="text/html" id="sidebar-content">
    <!-- Sidebar content -->
    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
        ...
        <nav class="mt-8 flex-1 px-2 space-y-1">
            ...
            <a href="{{ route('admin.dashboard') }}" 
               class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('admin.dashboard') ? 'bg-admin-primary text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
