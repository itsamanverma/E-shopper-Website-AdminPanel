    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="{{ url('/admin/dashboard') }}" title="Go to Home" class="tip-bottom"><i
                        class="icon-home"></i> Home</a> <a href="#">Products</a> <a href="#" class="current">Add Product
                    Images</a> </div>
                                ...
                                <thead>
                                    ...
                                    @foreach ($productsImages as $image)
                                        <tr>
                                            ...
                                            <td>
                                                <a rel="{{ $image->id }}" rel1="delete-alt-image" title="Delete Product Image"
                                                    href="javascript:"
