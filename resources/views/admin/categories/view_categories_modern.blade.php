<x-admin.layout-simple title="Categories">
    <style>
        .page-header {
            display: flex;
    ...
    <div class="table-container">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        @if($category->url)
                            <div class="category-slug">{{ $category->url }}</div>
                        @endif
                    ...
                    <td>
                        @if($category->status ?? true)
                            <span class="status-badge status-active">
                                <svg width="8" height="8" fill="currentColor" viewBox="0 0 8 8" style="margin-right: 4px;">
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="{{ url('/admin/edit-category/'.$category->id) }}" class="btn btn-edit btn-sm">
                            ...
                            <a href="{{ url('/admin/delete-category/'.$category->id) }}" 
                               ...
                               onclick="return confirm('Are you sure you want to delete this category? All products in this category will be affected.')">
                                <svg width="14" height="14" fill="currentColor" viewBox="0 0 20 20" style="margin-right: 4px;">
        ...
        <div class="empty-state">
            ...
            <h3 style="color: #374151; margin: 0 0 8px 0;">No Categories Found</h3>
            <p style="margin: 0 0 24px 0;">Start by creating your first product category.</p>
            <a href="{{ url('/admin/add-category') }}" class="btn btn-primary">
                <svg width="16" height="16" fill="currentColor" viewBox="0 0 20 20" style="margin-right: 8px;">
                    <path fill-rule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clip-rule="evenodd"/>
                </svg>
